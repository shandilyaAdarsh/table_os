...
const getStatusConfig = (status, elapsed) => {
  ...
  return {
    accentColor:  '#E31E24',
    headerBg:     'rgba(227,30,36,0.04)',
    timerColor:   '#6C757D',
    timerPulse:   false,
    showLate:     false,
    lateLabel:    '',
    outlineColor: 'rgba(227,30,36,0.15)',
  };
};

/* ─── Station chip colour map ─── */
const STATION_COLORS = {
  GRILL: { bg: '#FFF0F0', color: '#E31E24' },
  FRY:   { bg: '#FFF0F0', color: '#E31E24' },
  HOT:   { bg: '#FFF0F0', color: '#E31E24' },
...
const OrderCard = ({ order, isHistory = false, setConfirmModal }) => {
  const { id, tableNum, items, status, isPendingOperationalConfirmation } = order;
    ...
    >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '4px' }}>
          {!isHistory ? (
            ...
            <div style={{ 
              ...
              <div>{new Date(createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</div>
            </div>
          )}
        </div>
      </div>
          ...
          return (
            <div
              ...
              style={{
                ...
                margin:     '0 -8px',
                borderRadius: '6px',
                background: isSelected ? 'rgba(227, 30, 36, 0.05)' : 'transparent',
                opacity:    rowOpacity,
                cursor:     'pointer',
            ...
            >
              ...
              {isRejected ? (
                ...
                <span
                  className="material-symbols-outlined"
                  style={{ fontSize: '20px', color: '#E6E8EA', flexShrink: 0 }}
                >
      ...
      {!isHistory && (
        <div style={{
          padding:    '8px',
          background: '#F8F9FA',
          borderTop:  '1px solid rgba(227, 30, 36, 0.15)',
          flexShrink: 0,
        }}>
            ...
            <button
              ...
              style={{
                ...
                background: selectedItems.length > 0
                  ? 'linear-gradient(15deg, #E31E24, #C41B20)'
                  : '#E6E8EA',
