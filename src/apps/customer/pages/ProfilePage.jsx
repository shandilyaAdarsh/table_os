        ...
        <div style={{ background: 'white', borderRadius: 20, padding: 24, boxShadow: '0 10px 40px rgba(27,43,75,0.06)', border: '1px solid #F9FAFB' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 32 }}>
             ...
             <div>
                ...
                <p style={{ margin: 0, fontSize: 18, color: '#E31E24', fontWeight: 800 }}>{displayName}</p>
             </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 20 }}>
            <div>
              ...
              <p style={{ margin: '4px 0 0', fontSize: 15, color: '#E31E24', fontWeight: 700 }}>{displayPhone}</p>
            </div>
            <div>
              <span style={{ fontSize: 10, color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 800 }}>Current Table</span>
              <p style={{ margin: '4px 0 0', fontSize: 15, color: '#E31E24', fontWeight: 700 }}>{displayTable}</p>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 32 }}>
            <div>
              ...
              <p style={{ margin: '4px 0 0', fontSize: 13, color: '#E31E24', fontWeight: 700 }}>{displayDate}</p>
            </div>
            <div>
              <span style={{ fontSize: 10, color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: '0.05em', fontWeight: 800 }}>Session ID</span>
              <p style={{ margin: '4px 0 0', fontSize: 12, color: '#6C757D', fontFamily: 'monospace' }}>{displaySid}</p>
            </div>
          </div>
