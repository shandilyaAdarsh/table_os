 ...
 */
export async function getTableProjection(req: any, res: Response, next: any): Promise<void> {
  try {
    ...
    const branchId = req.headers['x-branch-id'] as string || req.context?.branch_id;
 ...
 */
export async function getReconciliation(req: any, res: Response, next: any): Promise<void> {
  try {
 ...
 */
export async function aggregateBill(req: any, res: Response, next: any): Promise<void> {
  try {
 ...
 */
export async function getBillDetails(req: any, res: Response, next: any): Promise<void> {
  try {
    const { id } = req.params;
    const tenantId = req.headers['x-tenant-id'] as string || req.context?.tenant_id;
 ...
 */
export async function createIntent(req: any, res: Response, next: any): Promise<void> {
  try {
 ...
 */
export async function settleIntent(req: any, res: Response, next: any): Promise<void> {
  try {
    const { id } = req.params;
 ...
 */
export async function settleBill(req: any, res: Response, next: any): Promise<void> {
  try {
    const { id } = req.params;
 ...
 */
export async function voidBill(req: any, res: Response, next: any): Promise<void> {
  try {
    const { id } = req.params;
 ...
 */
export async function executeRefund(req: any, res: Response, next: any): Promise<void> {
  try {
    const { id } = req.params;
