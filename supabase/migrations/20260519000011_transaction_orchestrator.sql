-- ============================================================
-- Migration: 20260519000011_transaction_orchestrator.sql
-- Commerce Hardening Pass: Server-side Transaction Orchestration.
-- Atomic Cart Checkout, Order generation, Invoice creation, KDS routing,
-- and Domain Outbox Event writing.
-- ============================================================
